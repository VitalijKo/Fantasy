...
from fantasy import metadata, wording
...
def run():
	...
	if answers is not None:
		...
		python_id = f'cp{sys.version_info.major}{sys.version_info.minor}'
		...
		if onnxruntime != 'coreml-silicon':
			...
			wheel_url = f'https://github.com/cansik/onnxruntime-silicon/releases/download/v{onnxruntime_version}/{wheel_name}'
