...
from fantasy.utilities import conditional_download, resolve_relative_path, is_file, is_download_done
...
def pre_process(mode):
	if not fantasy.globals.skip_download and not fantasy.globals.skip_download and not is_download_done(MODEL_URL, MODEL_PATH):
