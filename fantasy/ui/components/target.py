...
def render():
	...
	is_target_image = is_image(fantasy.globals.target_path)
	is_target_video = is_video(fantasy.globals.target_path)
	...
	TARGET_FILE = gradio.File(
		...
		value = fantasy.globals.target_path if is_target_image or is_target_video else None
	)
...
def update(file):
	...
	if file and is_image(file.name):
		fantasy.globals.target_path = file.name
	...
	fantasy.globals.target_path = None
