...
from vitswap.face_analyser import get_many_faces, clear_face_analyser
...
NAME = 'VITSWAP.FRAME_PROCESSOR.FACE_ENHANCER'
MODEL_URL = 'https://github.com/vitswap/vitswap-assets/releases/download/models/GFPGANv1.4.pth'
...
def process_video(source_path, temp_frame_paths):
	vitswap.processors.frame.core.multi_process_frames(None, temp_frame_paths, process_frames)
