...
from vitswap.face_analyser import get_face_analyser
from vitswap.face_cache import clear_faces_cache
from vitswap.processors.frame.core import get_frame_processors_modules
from vitswap.vision import count_video_frame_total
from vitswap.core import limit_resources, conditional_process
from vitswap.ui import core as ui
from vitswap.utilities import normalize_output_path, clear_temp
...
def start(benchmark_runs, benchmark_cycles):
	vitswap.globals.source_path = '.assets/examples/source.jpg'
...
def benchmark(target_path, benchmark_cycles):
	...
	for i in range(benchmark_cycles):
		vitswap.globals.target_path = target_path
		vitswap.globals.output_path = normalize_output_path(vitswap.globals.source_path, vitswap.globals.target_path, tempfile.gettempdir())
