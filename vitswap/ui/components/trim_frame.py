...
def render():
	...
	if is_video(vitswap.globals.target_path):
		...
		trim_frame_start_slider_args['value'] = vitswap.globals.trim_frame_start or 0
		trim_frame_start_slider_args['maximum'] = video_frame_total
		trim_frame_start_slider_args['visible'] = True

		trim_frame_end_slider_args['value'] = vitswap.globals.trim_frame_end or video_frame_total
...
def remote_update():
	if is_video(vitswap.globals.target_path):
		...
		vitswap.globals.trim_frame_start = None
		vitswap.globals.trim_frame_end = None
...
def update_trim_frame_start(trim_frame_start):
	vitswap.globals.trim_frame_start = trim_frame_start if trim_frame_start > 0 else None
...
def update_trim_frame_end(trim_frame_end):
	...
	vitswap.globals.trim_frame_end = trim_frame_end if trim_frame_end < video_frame_total else None
